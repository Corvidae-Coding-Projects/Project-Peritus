//! Identifiers for isolated harness evaluation and evolution campaigns.
...
/// Identifies one immutable evaluation campaign.
#[derive(Clone, Copy, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
pub struct EvaluationCampaignId(OpaqueIdentifier);
impl EvaluationCampaignId {
...
/// Identifies one evidence-backed harness evolution campaign.
#[derive(Clone, Copy, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
pub struct EvolutionCampaignId(OpaqueIdentifier);
impl EvolutionCampaignId {
    /// The binary representation length.
    pub const LENGTH: usize = 16;
    /// Returns the mathematical byte-array view.
    pub closed spec fn spec_bytes(&self) -> [u8; 16] { self.0.spec_bytes() }
