//! Fresh-subject conformance runner ownership.
...
#[test]
fn production_adapter_passes_all_provider_cases_with_fresh_loopback_subjects() {
    let created = Arc::new(AtomicUsize::new(0));
    let factory = Factory {
        descriptor: SubjectDescriptor::new(
            ReportText::new("Anthropic Messages").expect("name"),
