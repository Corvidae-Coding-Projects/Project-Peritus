-- Frozen pre-D0 C0 schema. Aggregate tags are restricted to one through five.
...
INSERT INTO store_meta(singleton, store_id, schema_version) VALUES (1, X'01010101010101010101010101010101', 1);
CREATE TABLE aggregate_heads (
    aggregate_kind INTEGER NOT NULL CHECK (aggregate_kind BETWEEN 1 AND 5),
...
CREATE INDEX state_history_producer ON state_record_history(producing_position, namespace, record_key);
CREATE TABLE outbox (
...
VALUES (1, X'ef5d066533db1afc26009028c186b29cfe53f4e6744d2e79f5295f981bc7813a', '0.0.0', X'01010101010101010101010101010101');
