...
The production registry contains six contiguous descriptors for release `0.0.0`. Version 1
...
preserving tags 1–12. Every step is exact-source SHA-256 checked and backup-required; all five
...
backup. Journal, artifact, projection, and evidence
