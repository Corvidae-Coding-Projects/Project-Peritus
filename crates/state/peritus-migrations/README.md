...
The production registry contains five contiguous descriptors for release `0.0.0`. Version 1
...
replacement. Every step is exact-source SHA-256 checked and backup-required; all four
...
extended with `Agent`, `Gate`, `Trace`, `Review`, `Scheduler`, `Collaboration`, and `Orchestrator`
records. A frozen v3 fixture additionally
...
migration, validates new tags 10–12, and restores the exact v4 backup. Journal, artifact,
