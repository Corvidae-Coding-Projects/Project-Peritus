...
Linux, the workspace-wide compiler probe runs alone with four build jobs first so compiler
contention cannot starve other bounded probe subjects. Each complete workspace is retained as a
workflow artifact.
