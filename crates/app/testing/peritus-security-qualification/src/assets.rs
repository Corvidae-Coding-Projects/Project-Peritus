...
const ASSETS: [BundledSecurityAsset; 13] = [
    ...
    BundledSecurityAsset {
        path: "security/schemas/native-probe-request-v1.schema.json",
        contents: include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/../../../../security/schemas/native-probe-request-v1.schema.json"
        )),
    },
    BundledSecurityAsset {
        path: "security/schemas/native-probe-response-v1.schema.json",
        contents: include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/../../../../security/schemas/native-probe-response-v1.schema.json"
        )),
    },
    BundledSecurityAsset {
        path: "security/schemas/native-shard-v1.schema.json",
        contents: include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
    ...
    BundledSecurityAsset {
        path: "security/schemas/native-host-facts-v1.schema.json",
        contents: include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/../../../../security/schemas/native-host-facts-v1.schema.json"
        )),
    },
    BundledSecurityAsset {
        path: "security/schemas/final-report-v1.schema.json",
        contents: include_str!(concat!(
            env!("CARGO_MANIFEST_DIR"),
            "/../../../../security/schemas/final-report-v1.schema.json"
        )),
    },
];
