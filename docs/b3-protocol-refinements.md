...
E0 orchestrator uses 76-78, E1 harness command/event/state uses 79-81, and E2 debugger
command/event/state uses 82-84. Their owning crates define the complete canonical payload codecs;
the B3 registry and generated TypeScript/schema declarations provide stable global family
identity.
