...
5. Cumulative model/time/tool/cost accounting and live stall status are complete on the draft
   qualification branch. Add the remaining durable effect-receipt ledger.
